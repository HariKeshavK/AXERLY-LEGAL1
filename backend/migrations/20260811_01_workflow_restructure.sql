...
revoke all on public.default_workflow_installations from public;
revoke all on public.quick_actions from public;
revoke all on public.workflow_addons from public;
revoke all on public.workflow_reference_documents from public;
revoke all on public.workflow_addon_reference_files from public;
