...
grant select, insert, update, delete on public.tabular_review_rows to axerly_app;
grant select, insert, update, delete on public.tabular_review_row_sources to axerly_app;
