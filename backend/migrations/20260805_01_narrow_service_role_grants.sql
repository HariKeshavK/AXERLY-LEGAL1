...
-- Narrow axerly_app's table/sequence privileges to the data operations the
...
--
-- Why it matters: axerly_app bypasses RLS by design, so its privileges
...
revoke all privileges on all tables in schema public from axerly_app;
grant select, insert, update, delete
  on all tables in schema public
  to axerly_app;

revoke all privileges on all sequences in schema public from axerly_app;
grant usage, select
