...
grant select, insert, update, delete on public.upload_sessions to axerly_app;
grant select, insert, update, delete on public.upload_session_files to axerly_app;
grant select, insert, update, delete on public.upload_processing_jobs to axerly_app;
