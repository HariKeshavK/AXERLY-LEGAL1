...
$function$;
GRANT ALL ON FUNCTION public.chat_access_role(uuid, uuid, uuid, uuid, text, text) TO axerly_app;
...
$function$;
GRANT ALL ON FUNCTION public.project_access_role(uuid, uuid, uuid, text, text) TO axerly_app;
...
$function$;
GRANT ALL ON FUNCTION public.review_access_role(uuid, uuid, uuid, uuid, text, text) TO axerly_app;
...
$function$;
GRANT ALL ON FUNCTION public.workflow_access_role(uuid, uuid, uuid, text, text) TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'chat_access_grants_created_by_fkey' AND conrelid = 'public.chat_access_grants'::regclass) THEN
    ALTER TABLE public.chat_access_grants ADD CONSTRAINT chat_access_grants_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.chat_access_grants TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'chats_user_id_fkey' AND conrelid = 'public.chats'::regclass) THEN
    ALTER TABLE public.chats ADD CONSTRAINT chats_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'org_invitations_invited_by_fkey' AND conrelid = 'public.org_invitations'::regclass) THEN
    ALTER TABLE public.org_invitations ADD CONSTRAINT org_invitations_invited_by_fkey FOREIGN KEY (invited_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.org_invitations TO axerly_app;
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.org_members TO axerly_app;
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.organizations TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'project_access_grants_created_by_fkey' AND conrelid = 'public.project_access_grants'::regclass) THEN
    ALTER TABLE public.project_access_grants ADD CONSTRAINT project_access_grants_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.project_access_grants TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'project_org_access_overrides_assigned_by_fkey' AND conrelid = 'public.project_org_access_overrides'::regclass) THEN
    ALTER TABLE public.project_org_access_overrides ADD CONSTRAINT project_org_access_overrides_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.project_org_access_overrides TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'project_subfolders_user_id_fkey' AND conrelid = 'public.project_subfolders'::regclass) THEN
    ALTER TABLE public.project_subfolders ADD CONSTRAINT project_subfolders_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tabular_review_access_grants_created_by_fkey' AND conrelid = 'public.tabular_review_access_grants'::regclass) THEN
    ALTER TABLE public.tabular_review_access_grants ADD CONSTRAINT tabular_review_access_grants_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.tabular_review_access_grants TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tabular_review_chats_user_id_fkey' AND conrelid = 'public.tabular_review_chats'::regclass) THEN
    ALTER TABLE public.tabular_review_chats ADD CONSTRAINT tabular_review_chats_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tabular_reviews_user_id_fkey' AND conrelid = 'public.tabular_reviews'::regclass) THEN
    ALTER TABLE public.tabular_reviews ADD CONSTRAINT tabular_reviews_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'workflow_org_access_overrides_assigned_by_fkey' AND conrelid = 'public.workflow_org_access_overrides'::regclass) THEN
    ALTER TABLE public.workflow_org_access_overrides ADD CONSTRAINT workflow_org_access_overrides_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
DO $do$ BEGIN
...
DO $do$ BEGIN
  ...
  END IF;
END $do$;
GRANT DELETE, INSERT, SELECT, UPDATE ON public.workflow_org_access_overrides TO axerly_app;
...
DO $do$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'workflows_user_id_fkey' AND conrelid = 'public.workflows'::regclass) THEN
    ALTER TABLE public.workflows ADD CONSTRAINT workflows_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
  END IF;
END $do$;
