...
tabularRouter.get("/", requireAuth, asyncRoute(async (req, res) => {
    ...
    const result = await listTabularReviews(createDatabase(), {
...
tabularRouter.get("/ids", requireAuth, asyncRoute(async (req, res) => {
    const query = req.query as Record<string, unknown>;
    const result = await listTabularReviewIds(createDatabase(), {
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
        projectIdFilter: projectIdFilterOf(query),
        scope: parseTabularReviewScope(query.scope),
...
tabularRouter.post("/", requireAuth, asyncRoute(async (req, res) => {
    ...
    const result = await createTabularReview(createDatabase(), {
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
        title,
        document_ids,
...
tabularRouter.post("/prompt", requireAuth, asyncRoute(async (req, res) => {
    const result = await draftColumnPrompt(createDatabase(), {
        userId: res.locals.userId as string,
...
tabularRouter.get("/:reviewId", requireAuth, asyncRoute(async (req, res) => {
    const result = await getTabularReviewDetail(createDatabase(), {
...
tabularRouter.get("/:reviewId/people", requireAuth, asyncRoute(async (req, res) => {
    const result = await getTabularReviewPeople(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
    });
...
tabularRouter.get("/:reviewId/access", requireAuth, asyncRoute(async (req, res) => {
    const result = await getTabularReviewAccess(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
    });
...
tabularRouter.post("/:reviewId/access", requireAuth, asyncRoute(async (req, res) => {
    const result = await grantTabularReviewAccess(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
...
tabularRouter.delete(
    ...
    asyncRoute(async (req, res) => {
        const result = await revokeTabularReviewAccess(createDatabase(), {
            reviewId: req.params.reviewId,
            userId: res.locals.userId as string,
            userEmail: res.locals.userEmail as string | undefined,
...
tabularRouter.patch("/:reviewId", requireAuth, asyncRoute(async (req, res) => {
    const result = await updateTabularReview(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
...
tabularRouter.delete("/:reviewId", requireAuth, asyncRoute(async (req, res) => {
    const result = await deleteTabularReview(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
    });
...
tabularRouter.post("/:reviewId/clear-cells", requireAuth, asyncRoute(async (req, res) => {
    ...
    const result = await clearTabularReviewCells(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
        rowIds: row_ids,
...
tabularRouter.post(
    ...
    asyncRoute(async (req, res) => {
        ...
        const result = await regenerateTabularCell(createDatabase(), {
            reviewId: req.params.reviewId,
            userId: res.locals.userId as string,
            userEmail: res.locals.userEmail as string | undefined,
            rowId: row_id,
...
tabularRouter.get("/:reviewId/chats", requireAuth, asyncRoute(async (req, res) => {
    const result = await listTabularReviewChats(createDatabase(), {
        reviewId: req.params.reviewId,
        userId: res.locals.userId as string,
        userEmail: res.locals.userEmail as string | undefined,
    });
...
tabularRouter.delete(
    ...
    requireAuth,
    asyncRoute(async (req, res) => {
        const result = await deleteTabularReviewChat(createDatabase(), {
            reviewId: req.params.reviewId,
...
tabularRouter.patch(
    ...
    requireAuth,
    asyncRoute(async (req, res) => {
        const result = await updateTabularReviewChat(createDatabase(), {
            reviewId: req.params.reviewId,
            chatId: req.params.chatId,
            userId: res.locals.userId as string,
            userEmail: res.locals.userEmail as string | undefined,
