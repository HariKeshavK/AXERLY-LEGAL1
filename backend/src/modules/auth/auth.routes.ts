...
// cookie-bearing database client, clearing auth cookies, reading the request
...
function cookieClient(req: Request, res: Response): Db | null {
  const client = res.locals.authClient as Db | undefined;
